...
public class Assignment1Q7 {
	...
	public static void main(String[] args) {
		...
		Details D3 = new Details("Mani", "ma@gmail.com", "Male");
		Details D4 = new Details("Abhi", "ab@gmail.com", "Male");
		...
		phoneNumber P3 = new phoneNumber(7036272669l);
		phoneNumber P4 = new phoneNumber(8985989059l);
		phoneNumber P5 = new phoneNumber(9133114049l);
