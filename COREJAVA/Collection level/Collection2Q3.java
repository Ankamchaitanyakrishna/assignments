...
public class Collection2Q3 {

	public static void main(String[] args) {
		Employee emp0= new Employee(1,"Chai", "mech", 10000);
		Employee emp1= new Employee(2,"Ahai", "ece", 10001);
		Employee emp2= new Employee(3,"Bhai", "cse", 10002);
		Employee emp3= new Employee(4,"Dhai", "eee", 10003);
		Employee emp4= new Employee(5,"Ehai", "it", 10004);
		Employee emp5= new Employee(6,"Fhai", "bba", 100005);
		Employee emp6= new Employee(7,"Ghai", "ms", 100006);
		Employee emp7= new Employee(8,"Hhai", "mba", 710000);
		Employee emp8= new Employee(9,"Ihai", "m.tech", 180000);
		Employee emp9= new Employee(10,"Jhai", "civil", 109000);
